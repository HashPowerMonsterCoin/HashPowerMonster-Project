...
"""Verify that starting hashpowermonster with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hashpowermonster with -h for help text")
        ...
        self.log.info("Start hashpowermonster with -version for version information")
        ...
        self.log.info("Start hashpowermonsterd with -fakearg to make sure it does not start")
