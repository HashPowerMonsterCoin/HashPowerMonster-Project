...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " hashpowermonster-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  hashpowermonster-tx [options] <hex-tx> [commands]  Update hex-encoded hashpowermonster transaction\n" +
            "or:     hashpowermonster-tx [options] -create [commands]   Create hex-encoded hashpowermonster transaction\n" +
            "\n";
