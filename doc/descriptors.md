# Support for Output Descriptors in HashpowerMonster Core

Since HashpowerMonster Core v0.17, there is support for Output Descriptors. This is a
...
on HashpowerMonster's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing HashpowerMonster Core wallets, a convenience function `combo` is
